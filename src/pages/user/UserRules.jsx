...
const UserRules = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-gradient-to-br from-secondary-800 to-secondary-700/70 rounded-xl shadow-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Rules Section */}
        <div className="bg-secondary-700/60 rounded-lg shadow-md p-6">
        ...
        <div className="bg-secondary-700 rounded-lg shadow-md p-6">
          <h3 className="text-2xl font-semibold  mb-4 flex items-center">
...
const DefinitionAccordion = ({ title, content, isOpen, toggle }) => {
  return (
    <div className="border border-gray-200 rounded-md">
      <button
        className="w-full px-4 py-3 text-left focus:outline-none focus:ring-2 focus:ring-indigo-500 flex justify-between items-center"
        onClick={toggle}
      >
      ...
      {isOpen && (
        <div className="px-4 py-3 text-gray-700 bg-indigo-50">{content}</div>
      )}
    </div>
  );
};

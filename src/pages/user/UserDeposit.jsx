        ...
        >
          ...
          <div className=" flex flex-col gap-2 w-full">
            ...
            <motion.div
              ...
              className="flex items-start gap-2 bg-amber-500/10 border border-amber-500/20 rounded-lg p-3 mt-2"
            >
              ...
              <div className="text-sm">
                ...
                <p className="text-amber-200/80 mt-1">
                  ...
                  <span className="font-semibold text-amber-300">$100</span>.
                  Deposits below this amount may result in fund loss.
                </p>
              </div>
            </motion.div>
          </div>
